          ...
          <div class="buttons-container">
            ...
            <div id="poweredByOpale">
              ...
              <img id="opaleLogo" src=${
                  OPALE_THEME === "dark"
                      ? "https://opale-public-assets.s3.eu-west-3.amazonaws.com/logo/opale-logo-no-bg-dark.png"
                      : "https://opale-public-assets.s3.eu-west-3.amazonaws.com/logo/opale-logo-no-bg.png"
              } alt="Opale.io">
            </div>
          </div>`;
