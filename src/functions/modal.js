...
export async function showVerificationOptions(identityProviders) {
    ...
    html += `<h5>${failureMessage}Choisissez l'une des options suivantes pour vérifier votre âge.</h5>
            ...
            <p>
              <small>Les vérifications sont sécurisées et anonymisées par <a href="https://opale.io" target="_blank">Opale.io</a> En utilisant ce service, vous acceptez notre <a href="https://opale.io/fr/politique-de-confidentialite/" target="_blank">Politique de Confidentialité</a>.</small>
            </p>
            `;
